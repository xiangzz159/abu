...
def load_kline_df_net(source, temp_symbol, n_folds, start, end, start_int, end_int, save, period):
    """
    ...
    if data_source.check_support():
        ...
        df = data_source.kline(n_folds=n_folds, start=start, end=end, period=period)
